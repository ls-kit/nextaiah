                ...
                <ul>
                  <li>
                    <a href="#0">
                      <img
                        ...
                        data-src="theme/img/twitter_icon.svg"
                        alt=""
                        className="lazy"
                      />
                    </a>
                  ...
                  <li>
                    <a href="#0">
                      <img
                        src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                        data-src="theme/img/facebook_icon.svg"
                        alt=""
                        className="lazy"
                      />
                    </a>
                  ...
                  <li>
                    <a href="#0">
                      <img
                        src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                        data-src="theme/img/instagram_icon.svg"
                        alt=""
                        className="lazy"
                      />
                    </a>
                  ...
                  <li>
                    <a href="#0">
                      <img
                        src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                        data-src="theme/img/youtube_icon.svg"
                        alt=""
                        className="lazy"
                      />
                    </a>
        ...
        <div className="row add_bottom_25">
          <div className="col-lg-6">
            <ul className="footer-selector clearfix">
              ...
              <li>
                <img
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  data-src="theme/img/cards_all.svg"
                  alt=""
                  width={198}
                  height={30}
                  className="lazy"
          ...
          <div className="col-lg-6">
            <ul className="additional_links">
              ...
              <li>
                <span>© 2023 ThemeKit Developed by Lskit</span>
              </li>
            </ul>
          </div>
        </div>
